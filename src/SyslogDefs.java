...
import java.util.*;
    ...
    public class SyslogDefs
    {
        ...
        static
        {
            ...
            facHash.put( "KERN",		Integer.valueOf(SyslogDefs.LOG_KERN) );
            facHash.put( "KERNEL",		Integer.valueOf(SyslogDefs.LOG_KERN) );
            facHash.put( "USER",		Integer.valueOf(SyslogDefs.LOG_USER) );
            facHash.put( "MAIL",		Integer.valueOf(SyslogDefs.LOG_MAIL) );
            facHash.put( "DAEMON",		Integer.valueOf(SyslogDefs.LOG_DAEMON) );
            facHash.put( "AUTH",		Integer.valueOf(SyslogDefs.LOG_AUTH) );
            facHash.put( "SYSLOG",		Integer.valueOf(SyslogDefs.LOG_SYSLOG) );
            facHash.put( "LPR",			Integer.valueOf(SyslogDefs.LOG_LPR) );
            facHash.put( "NEWS",		Integer.valueOf(SyslogDefs.LOG_NEWS) );
            facHash.put( "UUCP",		Integer.valueOf(SyslogDefs.LOG_UUCP) );
            facHash.put( "CRON",		Integer.valueOf(SyslogDefs.LOG_CRON) );
            facHash.put( "LOCAL0",		Integer.valueOf(SyslogDefs.LOG_LOCAL0) );
            facHash.put( "LOCAL1",		Integer.valueOf(SyslogDefs.LOG_LOCAL1) );
            facHash.put( "LOCAL2",		Integer.valueOf(SyslogDefs.LOG_LOCAL2) );
            facHash.put( "LOCAL3",		Integer.valueOf(SyslogDefs.LOG_LOCAL3) );
            facHash.put( "LOCAL4",		Integer.valueOf(SyslogDefs.LOG_LOCAL4) );
            facHash.put( "LOCAL5",		Integer.valueOf(SyslogDefs.LOG_LOCAL5) );
            facHash.put( "LOCAL6",		Integer.valueOf(SyslogDefs.LOG_LOCAL6) );
            facHash.put( "LOCAL7",		Integer.valueOf(SyslogDefs.LOG_LOCAL7) );

            priHash = new Hashtable( 20 );

            priHash.put( "EMERG",			Integer.valueOf(SyslogDefs.LOG_EMERG) );
            priHash.put( "EMERGENCY",		Integer.valueOf(SyslogDefs.LOG_EMERG) );
            priHash.put( "LOG_EMERG",		Integer.valueOf(SyslogDefs.LOG_EMERG) );
            priHash.put( "ALERT",			Integer.valueOf(SyslogDefs.LOG_ALERT) );
            priHash.put( "LOG_ALERT",		Integer.valueOf(SyslogDefs.LOG_ALERT) );
            priHash.put( "CRIT",			Integer.valueOf(SyslogDefs.LOG_CRIT) );
            priHash.put( "CRITICAL",		Integer.valueOf(SyslogDefs.LOG_CRIT) );
            priHash.put( "LOG_CRIT",		Integer.valueOf(SyslogDefs.LOG_CRIT) );
            priHash.put( "ERR",				Integer.valueOf(SyslogDefs.LOG_ERR) );
            priHash.put( "ERROR",			Integer.valueOf(SyslogDefs.LOG_ERR) );
            priHash.put( "LOG_ERR",			Integer.valueOf(SyslogDefs.LOG_ERR) );
            priHash.put( "WARNING",			Integer.valueOf(SyslogDefs.LOG_WARNING) );
            priHash.put( "LOG_WARNING",		Integer.valueOf(SyslogDefs.LOG_WARNING) );
            priHash.put( "NOTICE",			Integer.valueOf(SyslogDefs.LOG_NOTICE) );
            priHash.put( "LOG_NOTICE",		Integer.valueOf(SyslogDefs.LOG_NOTICE) );
            priHash.put( "INFO",			Integer.valueOf(SyslogDefs.LOG_INFO) );
            priHash.put( "LOG_INFO",		Integer.valueOf(SyslogDefs.LOG_INFO) );
            priHash.put( "DEBUG",			Integer.valueOf(SyslogDefs.LOG_DEBUG) );
            priHash.put( "LOG_DEBUG",		Integer.valueOf(SyslogDefs.LOG_DEBUG) );
        }
